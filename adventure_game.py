...
def gas_station(items):
    print_pause("You choose to drive to the nearest gas station to fill up on gas.")
...
def service_station(items):
    ...
    if "gas" in items:
        ...
        print_pause("After getting your % s inspected you find out nothing is wrong with it." % rnd_veh)
...
def drive_car(items):
    print_pause("Please enter the number for the location you want to drive to:")
